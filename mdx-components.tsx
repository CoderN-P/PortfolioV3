...
export function useMDXComponents(components: MDXComponents): MDXComponents {
  return {
    ...
    h2: (props) => (
      <h2 className="prose text-black text-3xl font-semibold" {...props} />
    ),
    h3: (props) => (
      <h3 className="prose text-black text-2xl font-semibold" {...props} />
    ),
    h4: (props) => (
      <h4 className="prose text-black text-xl font-semibold" {...props} />
    ),
    h5: (props) => (
      <h5 className="prose text-black text-lg font-semibold" {...props} />
    ),
    img: (props) => (
      <Image
        {...props}
