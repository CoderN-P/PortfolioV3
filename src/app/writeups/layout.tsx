...
export const metadata: Metadata = {
  ...
  description: "Read detailed writeups and technical documentation for Neel Parpia's projects including TRACER robotics platform, GPT-Kitbot, and other innovative solutions.",
