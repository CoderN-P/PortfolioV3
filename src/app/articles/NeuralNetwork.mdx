...
First, we need to compute the gradient of the loss function with respect to the output ($a1$) of the first layer activation function ($f_1$)

$$
\nabla_{a_1} L = \nabla_{z_2} L \cdot J_{f_1}(z_1)
$$

Where $J_{f_1}(z_1)$ is the Jacobian of the first layer activation function evaluated at $z_1$.
