...
export const metadata: Metadata = {
  ...
  description:
    "A collection of moments I've captured during my travels and hikes. Beautiful photography from national parks, mountains, and adventures.",
  keywords: [
    "photography",
    "travel",
    "hiking",
  ...
  openGraph: {
    title: "Gallery | Neel Parpia",
    description:
      "A collection of moments I've captured during my travels and hikes.",
    type: "website",
    locale: "en_US",
