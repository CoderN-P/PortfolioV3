...
export const metadata: Metadata = {
  ...
  description:
    "View my technical skills across programming languages, frameworks, and tools including Python, TypeScript, React, Svelte, AI/ML technologies, robotics, and more.",
  keywords: [
    "skills",
    "technologies",
    "programming",
