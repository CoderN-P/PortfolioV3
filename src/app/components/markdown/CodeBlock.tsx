...
export default function CodeBlock({
  ...
  const highlightCode = (code: string) => {
    let highlightedText = hljsMain.highlight(code, {
  ...
  if (!isHydrated) {
    ...
    return (
      <div
        className={`rounded-lg mb-8 mt-4 code-block bg-gray-200 w-full h-screen animate-pulse `}
      ></div>
    );
  }
        ...
        <div className="flex flex-row justify-between w-full">
          ...
          <div className="flex flex-row  bg-white border-b border-slate-200 px-4 py-3 rounded-t-lg flex-1 items-center justify-between gap-2">
              ...
              {fileName &&
                (url ? (
                  ...
                  >
                    <p
                      className={
                        "text-xs font-medium hover:text-blue-500! underline text-gray-600! p-0 !m-0 "
                      }
                  ...
                  <p
                    className={"text-xs font-medium text-gray-600 p-0 !m-0 "}
                    style={{ fontSize: "0.7em" }}
                  >
                    {fileName}
                  </p>
            ...
            <div className="flex flex-row gap-4 items-center">
              <p
                className="text-xs font-medium uppercase text-gray-700 p-0 !m-0"
                style={{ fontSize: "0.7em" }}
              >
                {validLanguage}
              </p>
